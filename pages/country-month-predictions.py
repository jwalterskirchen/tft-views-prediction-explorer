...
st.header('Country-level Historical Forecast and True Future Predictions')
...
with tab1:
    with st.expander("Evaluation Metrics:"):
        st.write('''
            ...
            CRPS measures accuracy and can be thought of as the mean absolute error equivalent for predictive distributions. Values get closer to 0 if the prediction distribution has low variance and is centred around actual values. 
            ...
            Lastly, MIS strikes a balance between having fairly narrow prediction intervals and a good coverage rate.
